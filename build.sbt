...
packageName in Docker := "classtimetable-reader"
...
libraryDependencies ++= {
  ...
  Seq(
    "io.sudostream.timetoteach" %% "messages" % "0.0.11-42",
...
javaOptions in run ++= Seq(
  ...
  "-DXms2048m -DXmx2048m -DXX:ReservedCodeCacheSize=256m -DXX:MaxMetaspaceSize=512m"
)
